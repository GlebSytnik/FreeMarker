package com.freemarker.interf;

import java.util.Optional;
import java.math.BigDecimal;
import com.freemarker.generic.GenericOperations;
import com.freemarker.mod.${metaDataInfoIndex.name};

public interface ${metaDataInfoIndex.name}Repository extends GenericOperations<${metaDataInfoIndex.name}> {
